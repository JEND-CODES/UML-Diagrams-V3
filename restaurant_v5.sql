...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim. 08 déc. 2020 à 16:22
...
INSERT INTO `address` (`id`, `street_number`, `street_name`, `post_code`, `town`, `client_id`, `deliverer_id`) VALUES
(1, 20, 'rue liberté', 75012, 'Paris', 1, NULL),
(2, 12, 'rue Saint-Ange', 13000, 'Marseille', NULL, 2);
...
(2, '2020-11-24 21:52:00', 'Baba au rhum', 'Savarin servi imbibé d\'un sirop au rhum', 'baba-au-rhum.jpg', '8.30', 'Dessert');
...
CREATE TABLE `order` (
  ...
  `dish_nb` int(11) NOT NULL,
  `dessert_nb` int(11) NOT NULL,
...
INSERT INTO `order` (`id`, `date`, `dish_nb`, `dessert_nb`, `total_cost`, `deliverer_start`, `delivery_end`, `client_id`, `address_id`, `payment_id`, `order_detail_id`, `deliverer_id`) VALUES
(1, '2020-11-24 00:00:00', 3, 0, '37.50', '00:05:00', '2020-11-25 00:15:00', 1, 1, 1, 1, 1);
...
INSERT INTO `order_detail` (`id`, `price`, `quantity`, `title`, `dish_id`) VALUES
(1, '37.50', 3, 'Salade César', 1),
(2, '33.20', 4, 'Baba au rhum', 2);
...
INSERT INTO `payment` (`id`, `date`, `payment_tool`, `client_id`) VALUES
(1, '2020-11-24 23:55:00', 'paypal', 1),
(2, '2020-11-24 23:56:00', 'visa', 2);
...
ALTER TABLE `address`
  ...
  ADD KEY `fk_data_deliverer` (`deliverer_id`) USING BTREE;
...
ALTER TABLE `order`
  ...
  ADD KEY `fk_data_order_detail` (`order_detail_id`),
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`deliverer_id`) REFERENCES `deliverer` (`id`),
  ADD CONSTRAINT `address_ibfk_2` FOREIGN KEY (`client_id`) REFERENCES `client` (`id`);
...
ALTER TABLE `order`
  ...
  ADD CONSTRAINT `fk_data_order_detail` FOREIGN KEY (`order_detail_id`) REFERENCES `order_detail` (`id`),
